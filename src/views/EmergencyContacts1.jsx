...
function EmergencyContacts1() {
  return (
    <div className="flex flex-col justify-center items-center">
			<div className="text-txt font-semibold text-4xl pt-32 font-family ">
				Emergency Contacts
			</div>
			<div className=" w-[24rem] h-96 bg-secondary rounded-2xl mt-8 shadow-xl">
				<div className=" w-[24rem] h-60 flex flex-col justify-evenly gap-3 items-center pt-10">
